...
const UrlForm = ({handleSubmit , focused ,setFocused ,setLoading ,loading , setUrl, url, resetForm}) => {
  return (
    <>
    <form onSubmit={handleSubmit} className=" flex gap-2  md:max-w-2xl lg:max-w-4xl mx-auto max-w-[410px] sm:mt-10 mt-8 ">
          <div className="relative group flex-1 ">
            ...
            <input
              ...
              className={`relative w-full font-sans-flex px-3 py-3 sm:px-5 sm:py-4 tracking-wider bg-slate-50/80  backdrop-blur-sm border-2 rounded-xl text-slate-900 placeholder-slate-400 outline-none transition-all duration-300 ${
                focused 
          ...
          <button
            type="submit"
            disabled={loading}
            className="sm:w-[25%]   bg-slate-900 hover:bg-slate-950 disabled:bg-slate-500 text-white sm:text-[16px] text-xs font-semibold 
